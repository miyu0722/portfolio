...
function seans(){
  ...
  var career2 = new ScrollMagic.Scene({triggerElement: "#trigger18", offset :1100, reverse:false})
      ...
      .addTo(controller);
  var career3 = new ScrollMagic.Scene({triggerElement: "#trigger19", offset :1200, reverse:false})
  ...
  var career4 = new ScrollMagic.Scene({triggerElement: "#trigger20", offset :1300, reverse:false})
      ...
      .addTo(controller);
  var career5 = new ScrollMagic.Scene({triggerElement: "#trigger21", offset :1400, reverse:false})
  ...
  var worksH1 = new ScrollMagic.Scene({triggerElement: "#trigger22", offset :2000, reverse:false})
      ...
      .addTo(controller);
  var worksP = new ScrollMagic.Scene({triggerElement: "#trigger23", offset :2100, reverse:false})
  ...
  var works2 = new ScrollMagic.Scene({triggerElement: "#trigger27", offset :2700, reverse:false})
      ...
      .addTo(controller);
  var works_t2 = new ScrollMagic.Scene({triggerElement: "#trigger28", offset :2800, reverse:false})
      .setClassToggle("#target28", "fadeInUp")
      // .addIndicators({name: "28"})
      .addTo(controller);
  var works_d2 = new ScrollMagic.Scene({triggerElement: "#trigger29", offset :2900, reverse:false})
      .setClassToggle("#target29", "fadeInUp")
      // .addIndicators({name: "29"})
      .addTo(controller);
  var works3 = new ScrollMagic.Scene({triggerElement: "#trigger30", offset :4000, reverse:false})
  ...
  var works4 = new ScrollMagic.Scene({triggerElement: "#trigger33", offset :5000, reverse:false})
      ...
      .addTo(controller);
  var works_t4 = new ScrollMagic.Scene({triggerElement: "#trigger34", offset :5200, reverse:false})
      .setClassToggle("#target34", "fadeInDown")
      // .addIndicators({name: "34"})
      .addTo(controller);
  var works_d4 = new ScrollMagic.Scene({triggerElement: "#trigger35", offset :5300, reverse:false})
      .setClassToggle("#target35", "fadeInDown")
      // .addIndicators({name: "35"})
      .addTo(controller);
  var works5 = new ScrollMagic.Scene({triggerElement: "#trigger36", offset :5500, reverse:false})
      .setClassToggle("#target36", "oval-fade-in2")
      // .addIndicators({name: "36"})
      .addTo(controller);
  var works_t5 = new ScrollMagic.Scene({triggerElement: "#trigger37", offset :5700, reverse:false})
      .setClassToggle("#target37", "fadeInUp")
      // .addIndicators({name: "37"})
      .addTo(controller);
  var works_d5 = new ScrollMagic.Scene({triggerElement: "#trigger38", offset :5800, reverse:false})
  ...
  var works_o1 = new ScrollMagic.Scene({triggerElement: "#trigger42", offset :3000, reverse:false})
  ...
  var works_o4 = new ScrollMagic.Scene({triggerElement: "#trigger45", offset :4000, reverse:false})
      ...
      .addTo(controller);
  var works_o5 = new ScrollMagic.Scene({triggerElement: "#trigger46", offset :5100, reverse:false})
  ...
  var works_h2 = new ScrollMagic.Scene({triggerElement: "#trigger51", offset :3500, reverse:false})
