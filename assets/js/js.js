...
//     // スクロールアニメーション
//     $('html,body').animate({scrollTop: targetX}, time, 'swing');
//     // ハッシュ書き換えとく
...
function seans(){
  ...
  var skilsOvalA = new ScrollMagic.Scene({triggerElement: "#triggerA", offset :200})
        .setClassToggle("#targetA", "oval-fade-in1")
        // .addIndicators({name: "A"})
        .addTo(controller);
  var skilsOvalB = new ScrollMagic.Scene({triggerElement: "#triggerB", offset :400})
...
function seans2(){
  var skilsOvalA = new ScrollMagic.Scene({triggerElement: "#triggerA", offset :200})
        ...
        // .addIndicators({name: "A"})
        .addTo(controller);
  var skilsOvalB = new ScrollMagic.Scene({triggerElement: "#triggerB", offset :300})
        .setClassToggle("#targetB", "oval-fade-in1")
        // .addIndicators({name: "B"})
        .addTo(controller);
  ...
  var myskills1 = new ScrollMagic.Scene({triggerElement: "#trigger3", offset :500})
      ...
      // .addIndicators({name: "3"})
      .addTo(controller);
  var myskills2 = new ScrollMagic.Scene({triggerElement: "#trigger4", offset :550})
      .setClassToggle("#target4", "fadeInUp")
      .on("enter",function(){
        var tag = $('.donut-chart.js-chart1');
        if(!$('.donut-chart.js-chart2').hasClass('js-added-scene')){
      ...
      // .addIndicators({name: "4"})
      .addTo(controller);
  var myskills3 = new ScrollMagic.Scene({triggerElement: "#trigger5", offset :600})
      .setClassToggle("#target5", "fadeInUp")
      .on("enter",function(){
        var tag = $('.donut-chart.js-chart3');
        if(!$('.donut-chart.js-chart3').hasClass('js-added-scene')){
      ...
      // .addIndicators({name: "5"})
      .addTo(controller);
  var myskills4 = new ScrollMagic.Scene({triggerElement: "#trigger6", offset :650})
      .setClassToggle("#target6", "fadeInUp")
      .on("enter",function(){
        var tag = $('.donut-chart.js-chart4');
        if(!$('.donut-chart.js-chart4').hasClass('js-added-scene')){
      ...
      // .addIndicators({name: "6"})
      .addTo(controller);
  var myskills5 = new ScrollMagic.Scene({triggerElement: "#trigger7", offset :700})
      .setClassToggle("#target7", "fadeInUp")
      .on("enter",function(){
        var tag = $('.donut-chart.js-chart5');
        if(!$('.donut-chart.js-chart5').hasClass('js-added-scene')){
      ...
      // .addIndicators({name: "7"})
      .addTo(controller);
  var myskills6 = new ScrollMagic.Scene({triggerElement: "#trigger8", offset :750})
      .setClassToggle("#target8", "fadeInUp")
      .on("enter",function(){
        var tag = $('.donut-chart.js-chart6');
        if(!$('.donut-chart.js-chart6').hasClass('js-added-scene')){
      ...
      // .addIndicators({name: "8"})
      .addTo(controller);
  var myskills7 = new ScrollMagic.Scene({triggerElement: "#trigger9", offset :800})
      ...
      // .addIndicators({name: "9"})
      .addTo(controller);
  var myskills8 = new ScrollMagic.Scene({triggerElement: "#trigger10", offset :850})
      ...
      // .addIndicators({name: "10"})
      .addTo(controller);
  var myskills9 = new ScrollMagic.Scene({triggerElement: "#trigger11", offset :900})
      ...
      // .addIndicators({name: "11"})
      .addTo(controller);
  var myskills10 = new ScrollMagic.Scene({triggerElement: "#trigger12", offset :950})
      ...
      // .addIndicators({name: "12"})
      .addTo(controller);
  var myskills11 = new ScrollMagic.Scene({triggerElement: "#trigger13", offset :1000})
      ...
      // .addIndicators({name: "13"})
      .addTo(controller);
  var myskills12 = new ScrollMagic.Scene({triggerElement: "#trigger14", offset :1050})
  ...
  var career = new ScrollMagic.Scene({triggerElement: "#trigger15", offset :1200})
      .setClassToggle("#target15", "fadeIn")
      // .addIndicators({name: "15"})
      .addTo(controller);
  var education = new ScrollMagic.Scene({triggerElement: "#trigger16", offset :1300})
      .setClassToggle("#target16", "fadeIn")
      // .addIndicators({name: "16"})
      .addTo(controller);
  var career1 = new ScrollMagic.Scene({triggerElement: "#trigger17", offset :1100})
      .setClassToggle("#target17", "oval-fade-in1")
      // .addIndicators({name: "17"})
      .addTo(controller);
  var career2 = new ScrollMagic.Scene({triggerElement: "#trigger18", offset :1100})
      .setClassToggle("#target18", "oval-fade-in2")
      // .addIndicators({name: "18"})
      .addTo(controller);
  var career3 = new ScrollMagic.Scene({triggerElement: "#trigger19", offset :1300})
      .setClassToggle("#target19", "oval-fade-in3")
      // .addIndicators({name: "19"})
      .addTo(controller);
  var career4 = new ScrollMagic.Scene({triggerElement: "#trigger20", offset :1300})
      .setClassToggle("#target20", "oval-fade-in4")
      // .addIndicators({name: "20"})
      .addTo(controller);
  var career5 = new ScrollMagic.Scene({triggerElement: "#trigger21", offset :1300})
      .setClassToggle("#target21", "oval-fade-in5")
      // .addIndicators({name: "21"})
      .addTo(controller);

  var worksH1 = new ScrollMagic.Scene({triggerElement: "#trigger22", offset :2000})
      .setClassToggle("#target22", "fadeInUp")
      // .addIndicators({name: "22"})
      .addTo(controller);
  var worksP = new ScrollMagic.Scene({triggerElement: "#trigger23", offset :2150})
      .setClassToggle("#target23", "fadeInUp")
      // .addIndicators({name: "23"})
      .addTo(controller);
  var works1 = new ScrollMagic.Scene({triggerElement: "#trigger24", offset :2200})
      .setClassToggle("#target24", "oval-fade-in1")
      // .addIndicators({name: "24"})
      .addTo(controller);
  var works_t1 = new ScrollMagic.Scene({triggerElement: "#trigger25", offset :2300})
      .setClassToggle("#target25", "fadeInUp")
      // .addIndicators({name: "25"})
      .addTo(controller);
  var works_d1 = new ScrollMagic.Scene({triggerElement: "#trigger26", offset :2400})
      .setClassToggle("#target26", "fadeInUp")
      // .addIndicators({name: "26"})
      .addTo(controller);
  var works2 = new ScrollMagic.Scene({triggerElement: "#trigger27", offset :2700})
      .setClassToggle("#target27", "oval-fade-in2")
      // .addIndicators({name: "27"})
      .addTo(controller);
  var works_t2 = new ScrollMagic.Scene({triggerElement: "#trigger28", offset :2900})
      .setClassToggle("#target28", "fadeInUp")
      // .addIndicators({name: "28"})
      .addTo(controller);
  var works_d2 = new ScrollMagic.Scene({triggerElement: "#trigger29", offset :3000})
      .setClassToggle("#target29", "fadeInUp")
      // .addIndicators({name: "29"})
      .addTo(controller);
  var works3 = new ScrollMagic.Scene({triggerElement: "#trigger30", offset :3300})
      .setClassToggle("#target30", "oval-fade-in3")
      // .addIndicators({name: "30"})
      .addTo(controller);
  var works_t3 = new ScrollMagic.Scene({triggerElement: "#trigger31", offset :3400})
      .setClassToggle("#target31", "fadeInUp")
      // .addIndicators({name: "31"})
      .addTo(controller);
  var works_d3 = new ScrollMagic.Scene({triggerElement: "#trigger32", offset :3500})
      .setClassToggle("#target32", "fadeInUp")
      // .addIndicators({name: "32"})
      .addTo(controller);
  var works4 = new ScrollMagic.Scene({triggerElement: "#trigger33", offset :3800})
      .setClassToggle("#target33", "oval-fade-in1")
      // .addIndicators({name: "33"})
      .addTo(controller);
  var works_t4 = new ScrollMagic.Scene({triggerElement: "#trigger34", offset :3900})
      .setClassToggle("#target34", "fadeInUp")
      // .addIndicators({name: "34"})
      .addTo(controller);
  var works_d4 = new ScrollMagic.Scene({triggerElement: "#trigger35", offset :4000})
      .setClassToggle("#target35", "fadeInUp")
      // .addIndicators({name: "35"})
      .addTo(controller);
  var works5 = new ScrollMagic.Scene({triggerElement: "#trigger36", offset :4300})
      .setClassToggle("#target36", "oval-fade-in2")
      // .addIndicators({name: "36"})
      .addTo(controller);
  var works_t5 = new ScrollMagic.Scene({triggerElement: "#trigger37", offset :4400})
      .setClassToggle("#target37", "fadeInUp")
      // .addIndicators({name: "37"})
      .addTo(controller);
  var works_d5 = new ScrollMagic.Scene({triggerElement: "#trigger38", offset :4500})
      .setClassToggle("#target38", "fadeInUp")
      // .addIndicators({name: "38"})
      .addTo(controller);
  var works6 = new ScrollMagic.Scene({triggerElement: "#trigger39", offset :4700})
      .setClassToggle("#target39", "oval-fade-in3")
      // .addIndicators({name: "39"})
      .addTo(controller);
  var works_t6 = new ScrollMagic.Scene({triggerElement: "#trigger40", offset :4800})
      .setClassToggle("#target40", "fadeInUp")
      // .addIndicators({name: "40"})
      .addTo(controller);
  var works_d6 = new ScrollMagic.Scene({triggerElement: "#trigger41", offset :4900})
      .setClassToggle("#target41", "fadeInUp")
      // .addIndicators({name: "41"})
      .addTo(controller);

  var works_o1 = new ScrollMagic.Scene({triggerElement: "#trigger42", offset :2250})
      .setClassToggle("#target42", "oval-fade-in4")
      // .addIndicators({name: "42"})
      .addTo(controller);
  var works_o2 = new ScrollMagic.Scene({triggerElement: "#trigger43", offset :2400})
      .setClassToggle("#target43", "oval-fade-in5")
      // .addIndicators({name: "43"})
      .addTo(controller);
  var works_o3 = new ScrollMagic.Scene({triggerElement: "#trigger44", offset :2800})
      .setClassToggle("#target44", "oval-fade-in1")
      // .addIndicators({name: "44"})
      .addTo(controller);
  var works_o4 = new ScrollMagic.Scene({triggerElement: "#trigger45", offset :3000})
      .setClassToggle("#target45", "oval-fade-in2")
      // .addIndicators({name: "45"})
      .addTo(controller);
  var works_o5 = new ScrollMagic.Scene({triggerElement: "#trigger46", offset :3200})
      .setClassToggle("#target46", "oval-fade-in3")
      // .addIndicators({name: "46"})
      .addTo(controller);
  var works_o6 = new ScrollMagic.Scene({triggerElement: "#trigger47", offset :3800})
      .setClassToggle("#target47", "oval-fade-in4")
      // .addIndicators({name: "47"})
      .addTo(controller);
  var works_o7 = new ScrollMagic.Scene({triggerElement: "#trigger48", offset :4200})
      .setClassToggle("#target48", "oval-fade-in5")
      // .addIndicators({name: "48"})
      .addTo(controller);
  var works_o8 = new ScrollMagic.Scene({triggerElement: "#trigger49", offset :4400})
      .setClassToggle("#target49", "oval-fade-in1")
      // .addIndicators({name: "49"})
      .addTo(controller);
  var works_o9 = new ScrollMagic.Scene({triggerElement: "#trigger50", offset :4500})
      .setClassToggle("#target50", "oval-fade-in2")
      // .addIndicators({name: "50"})
      .addTo(controller);
  var works_o10 = new ScrollMagic.Scene({triggerElement: "#trigger69", offset :4600})
      .setClassToggle("#target69", "oval-fade-in3")
      // .addIndicators({name: "69"})
      .addTo(controller);

  var contact_o1 = new ScrollMagic.Scene({triggerElement: "#trigger70", offset :5500})
      .setClassToggle("#target70", "oval-fade-in3")
      // .addIndicators({name: "70"})
      .addTo(controller);
